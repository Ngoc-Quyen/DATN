  ...
  compute it */
        ...
        update: function (reset) {
            ...
            if (circumference < Math.PI * 2.0) {
                ...
                var max = {
                    ...
                    y: contains90
                        ? 1
                        : Math.max(start.y * (start.y > 0 ? 1 : cutout), end.y * (end.y > 0 ? 1 : cutout)),
                };
        ...
        _resolvePointOptions: function (element, index) {
            ...
            for (i = 0, ilen = keys.length; i < ilen; ++i) {
                ...
                values[key] = resolve$4(
                    [custom[key], dataset[ELEMENT_OPTIONS[key]], dataset[key], options[key]],
                    context,
                    index
                );
            }
        ...
        fit: function () {
            ...
            if (tickOpts.display && display) {
                ...
                if (isHorizontal) {
                    ...
                    var labelHeight =
                        sinRotation * largestTextWidth + tickFont.lineHeight * tallestLabelHeightInLines + lineSpace; // padding
    ...
    function getTickBackdropHeight(opts) {
        ...
        if (tickOpts.display && opts.display) {
            return (
                valueOrDefault$b(tickOpts.fontSize, core_defaults.global.defaultFontSize) +
    ...
    var scale_time = core_scale.extend({
        ...
        getValueForPixel: function (pixel) {
            ...
            var pos =
                (size ? (pixel - start) / size : 0) * (me._offsets.start + 1 + me._offsets.start) - me._offsets.end;
